...
const GenerationError: React.FC<GenerationErrorProps> = ({ error, handleRetry }) => (
  <div className="max-w-2xl mx-auto space-y-6">
    <div className="text-center mb-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-4">Generation Failed</h1>
      <p className="text-lg text-gray-600">We encountered an error while generating your questions</p>
    </div>
